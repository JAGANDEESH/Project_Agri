...
import {  Leaf, List,  Pencil,  Save, Trash2, Users, Weight, X } from 'lucide-react';
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-6 border border-green-200/50 flex-1 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl shadow-lg">
                    <Weight className="text-white" size={22} />
                  </div>
                  <div>
                    <h2 className="text-xl font-bold text-gray-800">
                      {formData.id ? 'Edit Unit Of Measurement' : 'Add New Unit Of Measurement'}
                    </h2>
                    <p className="text-sm text-green-600">Manage your unit of measurement efficiently</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 h-full flex flex-col">
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="flex flex-row gap-3 pt-4 flex-wrap sm:flex-nowrap">
                      ...
                      >
                        <Save size={16} />
                        {formData.id ? 'Update UOM' : 'Add UOM'}
                      </button>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-green-200/50 overflow-hidden flex-1 flex flex-col relative">
                ...
                <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-6 mt-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">Unit Of Measurement Details</h2>
                      <p className="text-green-100 text-sm flex items-center gap-2">
                        <Weight size={14} />
                        Total UOM : {uoms.length}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 flex-1 overflow-hidden">
                  {uoms.length === 0 ? (
                    <div className="text-center py-12 h-full flex flex-col justify-center">
                      <div className="mb-4">
                        <Weight className="mx-auto text-green-400 mb-3" size={48} />
                        <div className="text-4xl mb-2">🌱</div>
                      </div>
                      <p className="text-gray-600 text-xl font-semibold">No UOM yet</p>
                            ...
                            >
                              ...
                              <td className="py-4 px-4">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <span className="font-semibold text-gray-800 text-sm">{uom.name}</span>
