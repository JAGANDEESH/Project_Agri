...
import { Leaf, List, Package, Package2, Pencil, Save, Trash2, Users, Weight, X } from 'lucide-react';
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-800">
                      {formData.id ? 'Edit Packing Unit' : 'Add New Packing Unit'}
                    </h2>
                    <p className="text-sm text-green-600">Manage your packing unit efficiently</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 h-full flex flex-col">
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="flex flex-row gap-3 pt-4 flex-wrap sm:flex-nowrap">
                      ...
                      >
                        <Save size={16} />
                        {formData.id ? 'Update Packing Unit' : 'Add Packing Unit'}
                      </button>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-green-200/50 overflow-hidden flex-1 flex flex-col relative">
                ...
                <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-6 mt-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">Packing Unit Details</h2>
                      <p className="text-green-100 text-sm flex items-center gap-2">
                        <Package size={14} />
                        Total Packing Units : {units.length}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 flex-1 overflow-hidden">
                  {units.length === 0 ? (
                    <div className="text-center py-12 h-full flex flex-col justify-center">
                      ...
                      <p className="text-gray-600 text-xl font-semibold">No packing units yet</p>
